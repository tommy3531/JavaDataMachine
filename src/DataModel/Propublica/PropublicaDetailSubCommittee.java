...
public class PropublicaDetailSubCommittee {
    ...
    public String getRank_in_party() {
        return rank_in_party;
    }

    public void setRank_in_party(String rank_in_party) {
        this.rank_in_party = rank_in_party;
    }
