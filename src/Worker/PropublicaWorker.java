...
import Service.PropublicaService;
import org.apache.http.client.methods.HttpGet;

import java.util.ArrayList;

/*
    Propublica Single Reponsibility
        - Find information about ArrayList<PropublicaSenator> senators
...
public class PropublicaWorker {
    ...
    public PropublicaService propublicaService;

    public PropublicaWorker() {

        client = new PropublicaClient();
        propublicaService = new PropublicaService();
